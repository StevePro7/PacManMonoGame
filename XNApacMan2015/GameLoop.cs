...
namespace XNAPacMan {
    ...
    public class GameLoop : Microsoft.Xna.Framework.DrawableGameComponent {
        ...
        public override void Initialize() {
			...
			var blinky = new Ghost(Game, player_, Ghosts.Blinky);
			var clyde = new Ghost(Game, player_, Ghosts.Clyde);
        ...
        public override void Draw(GameTime gameTime) {
            ...
            // Otherwise ... (well yeah I could've written "else" but that would make the code indented even more!!! identation is bad !!! aargh !!! AAAAAAAAARRRGH!!!)
